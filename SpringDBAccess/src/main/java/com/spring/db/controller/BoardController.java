...
public class BoardController {
    ...
    public void list(Model model) {
    	...
    	model.addAttribute("bList", service.showAllArticles());
    }
    ...
    @GetMapping("/content")
    public String showDetails(int num) {
    	System.out.println("33333");
    	service.showDetails(num);
    ...
    @GetMapping("/modify")
    public String modifyArticle(int num) {
    	System.out.println("44444");
    	service.modifyArticle(num);
    	return "board/modify";
    }
    ...
    @GetMapping("/delete")
    public String deleteArticle(int num, RedirectAttributes ra) {

...
public class RequestController {
	...
	//요청이 들어온 URL 값을 뷰 리졸버(view resolver)에게 전달
	@GetMapping("/join")
	...
	//같은 주소를 사용하는게 가능하다(GET -> 화면 처리/ POST -> 입력값 처리)

	/*
	 # 스프링에서 요청과 함께 전달된 데이터를 처리하는 방식

	 1. 전통적인 jsp/servlet 방식의 파라미터 읽기 처리 방법
	 - HttpServletRequest 객체를 활용(jsp에서 사용)
	 */
	//	@PostMapping("/join")
